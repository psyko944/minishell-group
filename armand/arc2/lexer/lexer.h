...
# include "cut_command/tokenize.h"

// Content is for not yet parsed text, soft_content is parenthesis content 
// and command contains either a whole command or it's separator
typedef struct s_lexed_list {
	char				*content;
	struct s_lexed_list	*soft_content;
	t_parsed_cmd_cont	*parsed_content;
